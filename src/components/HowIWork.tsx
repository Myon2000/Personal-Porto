      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 space-y-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 pt-2">
          {steps.map((step) => (
            <div
              key={step.num}
              className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs hover:border-slate-400 dark:hover:border-slate-600 transition-colors space-y-3 flex flex-col justify-between"
            >
