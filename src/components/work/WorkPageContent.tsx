...
export default function WorkPageContent() {
 ...
 className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-lg border border-slate-200 hover:border-slate-400 text-slate-700 text-xs font-mono transition-colors min-h-[38px]"
 ...
 <h4 className="text-base sm:text-lg font-bold text-slate-900 group-hover:text-[#EA3826] transition-colors">
 {item.title}
 </h4>
 </div>
 ...
 <div
 key={exp.id}
 className="p-6 sm:p-8 rounded-2xl border border-slate-200 bg-white shadow-xs hover:border-slate-400 transition-colors space-y-4"
 >
 ...
 <span className="font-mono text-xs text-slate-500 bg-slate-50 px-3 py-1 rounded-md self-start sm:self-auto shrink-0">
 {exp.period}
 </span>
 </div>
