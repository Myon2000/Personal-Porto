...
export default function HeroSection() {
 ...
 return (
 <section className="relative min-h-[88vh] sm:min-h-[92vh] flex flex-col justify-between px-6 sm:px-10 lg:px-16 pt-10 sm:pt-14 pb-12 sm:pb-16 bg-white transition-colors border-b border-slate-200 overflow-hidden select-none">
 {/* Interactive Dot Vortex Canvas (z-0 in front of background, behind z-10 text) */}
 <HeroDotField />

 {/* Subheader Status Row (relative z-10) */}
 <div className="relative z-10 flex items-center justify-between text-xs font-mono tracking-[0.2em] uppercase text-slate-500 pt-2 sm:pt-4">
 ...
 <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[6.5rem] xl:text-[7.2rem] font-extrabold tracking-[-0.04em] text-slate-950 leading-[0.98]">
 {language ==="id"? (
 <>
 ...
 <div className="relative z-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6 pt-4 border-t border-slate-100">
