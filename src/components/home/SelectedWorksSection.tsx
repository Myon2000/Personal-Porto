    ...
    >
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 space-y-14">
            ...
            >
              ...
              <div className="space-y-3 max-w-2xl">
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-0.5 rounded text-[10px] font-mono bg-slate-50 dark:bg-slate-800/80 text-slate-600 dark:text-slate-400"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="flex flex-row md:flex-col items-center md:items-end gap-2.5 shrink-0 pt-2 md:pt-0 border-t md:border-t-0 border-slate-100 dark:border-slate-800">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-800 hover:border-slate-400 dark:hover:border-slate-600 text-slate-700 dark:text-slate-300 text-xs font-mono transition-colors min-h-[38px]"
        ...
        <div className="pt-2 flex justify-center sm:justify-end">
          <Link
            href="/work"
            className="inline-flex items-center gap-2 font-mono text-xs sm:text-sm font-bold tracking-[0.2em] uppercase text-slate-950 dark:text-white hover:text-[#EA3826] dark:hover:text-[#EA3826] transition-colors group"
          >
            <span>
              {language === "id"
