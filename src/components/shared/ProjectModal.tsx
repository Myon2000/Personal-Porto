...
export default function ProjectModal({ project, isOpen, onClose }: ProjectModalProps) {
 ...
 >
 <div
 className="relative w-full max-w-4xl my-6 rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200"
 onClick={(e) => e.stopPropagation()}
 >
 {/* Modal Window Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/80">
 <div className="flex items-center gap-2">
 <span className="px-2.5 py-1 rounded-md text-xs font-semibold bg-sky-100 text-sky-700 border border-sky-200">
 ...
 type="button"
 onClick={onClose}
 className="p-1.5 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500"
 ...
 <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-emerald-100 text-emerald-700 font-semibold">
 Laravel + Blade + MySQL
 </span>
 </div>
 ...
 <div className="rounded-xl border border-slate-200 bg-slate-950 overflow-hidden shadow-xl">
 {/* Browser Top Chrome */}
 ...
 <div className="w-5 h-5 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center font-bold text-[10px]">
 1
 </div>
 <p className="font-bold text-slate-900 font-sans text-xs">Petani Terdaftar</p>
 ...
 <p className="font-bold text-slate-900 font-sans text-xs">Pengecekan Kuota</p>
 <p className="text-[11px] text-slate-500 font-sans">
 ...
 <p className="font-bold text-slate-900 font-sans text-xs">Tebus Kios Resmi</p>
 <p className="text-[11px] text-slate-500 font-sans">
 ...
 <p className="font-bold text-slate-900 font-sans text-xs">Audit &amp; Laporan</p>
 <p className="text-[11px] text-slate-500 font-sans">
 ...
 <div className="flex items-start gap-2 p-3 rounded-lg bg-white border border-slate-200">
 <Database className="w-4 h-4 text-sky-500 shrink-0 mt-0.5"/>
 <div>
 <strong className="text-slate-900">Relational Data Integrity:</strong>
 ...
 <div className="p-4 rounded-xl border border-sky-200 bg-sky-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
 ...
 <span className="px-2 py-0.5 rounded text-[11px] font-mono bg-sky-100 text-sky-700 font-semibold border border-sky-200">
 Laravel 12
 </span>
 <span className="px-2 py-0.5 rounded text-[11px] font-mono bg-indigo-100 text-indigo-700 font-semibold border border-indigo-200">
 Flask AI API
 </span>
 <span className="px-2 py-0.5 rounded text-[11px] font-mono bg-emerald-100 text-emerald-700 font-semibold border border-emerald-200">
 EfficientNet CNN
 </span>
 </div>
 </div>
 ...
 {/* Image Frame */}
 <div className="rounded-xl border border-slate-200 bg-slate-950 overflow-hidden shadow-lg">
 ...
 <div
 key={idx}
 className="p-3 rounded-lg bg-white border border-slate-200 space-y-1 text-xs"
 >
 <div className="flex items-center justify-between">
 ...
 <p className="text-[10px] font-mono text-sky-600">{item.type}</p>
 <p className="text-[11px] text-slate-500 leading-relaxed pt-0.5">
 <span className="font-semibold text-slate-700">SOP:</span> {item.sop}
 </p>
 </div>
 ))}
 </div>
 ...
 <div
 key={idx}
 className="flex items-start gap-2 text-xs text-slate-700 p-2.5 rounded-lg bg-slate-50 border border-slate-100"
 >
 ...
 <span
 key={tag}
 className="px-2.5 py-1 rounded-md bg-slate-100 text-slate-700 font-mono text-xs font-medium"
 >
 {tag}
 </span>
 ))}
 ...
 type="button"
 onClick={onClose}
 className="w-full sm:w-auto px-4 py-2 rounded-lg border border-slate-300 hover:bg-slate-100 text-xs sm:text-sm font-semibold text-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500 min-h-[38px]"
 >
